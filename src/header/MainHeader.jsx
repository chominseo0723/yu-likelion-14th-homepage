...
const MainHeader = ({ scrollToHome }) => {
  ...
  return (
    <div className="relative font-pretendard py-9 max-md:py-4 bg-transparent glass-header z-50">
      <div
...
>
  ...
  >
    14기 지원하기
      ...
      {/* 모바일 - 메뉴 슬라이드 */}
      <div
        className={`md:hidden fixed top-0 right-0 h-full w-[280px] bg-black backdrop-blur-xl border-l border-white/10 z-40 transition-transform duration-300 ease-in-out ${

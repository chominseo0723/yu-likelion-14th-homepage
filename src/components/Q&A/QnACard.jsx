  ...
  return (
    <div className="w-full sm:w-96 md:w-[500px] lg:w-175 mb-6 max-md:mb-5 font-pretendard max-w-[90vw]">
      ...
      <span
        ...
        style={
          isMobile
            ? (isOpen ? qnaQuestionOpenStyleMobile : qnaQuestionClosedStyleMobile)
            : (isOpen ? qnaQuestionOpenStyle : qnaQuestionClosedStyle)
        }
      >
        Q. {q}
      </span>
      ...
      >
        <div
          className="
            glass-qna
            px-8 max-md:px-3 py-6 max-md:py-3
            rounded-b-[30px] max-md:rounded-b-[20px]
            border-t-0
          "
        >
          <div
            className="leading-relaxed whitespace-pre-line pl-[1em] -indent-[1em] max-md:break-all"
            style={
              isMobile
